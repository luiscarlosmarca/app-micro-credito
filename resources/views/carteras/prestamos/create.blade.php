...
<form method="POST" v-on:submit.prevent="createPrestamo">
  <div class="modal fade" id="create-prestamo" role="dialog" > 
       ...
       <div class="modal-body">
         <div class="row"> 
          <div class="col-md-6">
              ...
              {{ Form::select('cartera_id', ['class'=>'form-control cartera_id'],['v-model'=>'cartera_id']) }}

              <label for="persona">Cliente</label>
              {{ Form::select('cliente_id', ['class'=>'form-control cliente_id'],['v-model'=>'cliente_id']) }}
